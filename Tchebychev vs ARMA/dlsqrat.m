...
% 
% Copied from: 
% C.F. Borges, A Full-Newton Approach to Separable Nonlinear Least Squares Problems and
% its Application to Discrete Least Squares Rational Approximation, Electronic Transactions
% on Numerical Analysis, Volume 35, pp.57-68, 2009.
...
if rel_err > TOLERANCE
    ...
    function update(alpha)
        % This function updates the model matrix and computes 
